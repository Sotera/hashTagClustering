...
def create_index(es_url=None, delete_old=False):
    ...
    if delete_old==True:
        i_client.delete(index="jag_hc2_documents")
        i_client.delete(index="jag_hc2_clusters")

    i_client.create(index="jag_hc2_documents", \
        body = '''{
            "settings" : {
                "number_of_shards" : 3,
    ...
    i_client.create(index="jag_hc2_clusters", \
        body = '''{
            "settings" : {
                "number_of_shards" : 3,
                "number_of_replicas" : 1
